...
(function() {
    ...
    app.controller("CustomerFormCntrolr", ['$scope', '$rootScope', 'sharedService', "RestService", "APP_CONST", "$uibModal", "GNG_GA", "notifier", "$state", "UserService",
                ...
                RestService.saveToServer('get-image-by-id-base64', json).then(function(Response) {
                    ...
                    if (Response.sByteCode != undefined && Response.sByteCode != null && Response.sByteCode != "") {
                        ...
                        if (kycName == "PAN") {
                            ...
                            if ($scope.evidence != undefined) {} else {
